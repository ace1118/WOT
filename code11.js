...
gdjs.mission_321Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(57415692);
}
}if (gdjs.mission_321Code.condition0IsTrue_0.val) {
{gdjs.evtTools.sound.playMusic(runtimeScene, "mission_notif.mp3", false, 100, 1);
}{gdjs.evtTools.sound.playSound(runtimeScene, "mission 1.mp3", false, 60, 1);
}}
...
{
{gdjs.mission_321Code.conditionTrue_1 = gdjs.mission_321Code.condition0IsTrue_0;
gdjs.mission_321Code.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(57417124);
}
}if (gdjs.mission_321Code.condition0IsTrue_0.val) {
...
gdjs.mission_321Code.condition0IsTrue_0.val = false;
{
gdjs.mission_321Code.condition0IsTrue_0.val = gdjs.evtTools.runtimeScene.getTimerElapsedTimeInSecondsOrNaN(runtimeScene, "bg_music") > 26;
}if (gdjs.mission_321Code.condition0IsTrue_0.val) {
...
for(var i = 0, k = 0, l = gdjs.mission_321Code.GDtimerObjects1.length;i<l;++i) {
    if ( gdjs.mission_321Code.GDtimerObjects1[i].getTimerElapsedTimeInSecondsOrNaN("timer") > 26 ) {
